    ...
    <div id="wrapper">
      <h1>M.I.N.E. - Mine Initiative of Nations Everywhere</h1>
			<aside id="gameMenu">
				...
				<br /><br />
				<h4>Game Menu</h4>
				Difficulty:<select id="difficultyChoice">
					<option value="Beginner" id="Beginner" selected="selected">Beginner</option>
				...
				<br />
				Map Style:<br />
					<label for="Classic"><input id="Classic" type="radio" name="mineField" value="Classic" checked="checked" />Classic</label><br />
					<label for="Grassy"><input id="Grassy" type="radio" name="mineField" value="Grassy" />Grassy</label><br />
				...
				Focus Music:
				<img id="bMusicPlayer" height="63px" width="63px" src="img/pause-play-button.png" onclick="if($('musicPlayer').paused){$('musicPlayer').play()} else {$('musicPlayer').pause()}" />
